...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
          ...
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  p.mb-0 Para ampliar la información sobre este tema lo invitamos a ver el video #[b Confiabilidad y validez de un instrumento de investigación I].
                .col-sm-auto
    ...
    p(data-aos="fade-down") Bajo este concepto, existen tres criterios principales y cuentan con las siguientes características:
        ...
        .tarjeta.color-primario.p-3(data-aos="flip-up")
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  p.mb-0 Para ampliar la información sobre tipos de preguntas lo invitamos a ver el video #[b Tipos de preguntas en una encuesta].
                .col-sm-auto
    ...
    p(data-aos="fade-down").mb-4 A continuación, se relacionarán las recomendaciones a tener en cuenta para la aplicación de instrumentos: 
