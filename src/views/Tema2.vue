...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p(data-aos="fade-down").mb-4 A continuación, se presentan los diferentes tipos de fuentes de información según lo expuesto por Rivera, M. & Fernández, M. (2015), estas serán de gran apoyo al investigador para la focalización de la información

    .row.justify-content-center.align-items-start.mb-3          
      .col-lg-7.order-2.order-lg-1
        AcordionA(data-aos="fade-right")(tipo="a" clase-tarjeta="tarjeta bg1")
    ...
    p(data-aos="fade-down").mb-4 De acuerdo con Rivera & Fernández (2015), los criterios para la selección de la fuente de información, están basados en tres criterios fundamentales, los cuales serán expuestos a continuación:
    ...
    p(data-aos="fade-down").mb-4 Previa a la selección de las técnicas de información es necesario considerar y conocer ciertas características:

    .row.justify-content-center.align-items-start.mb-4
      .col-lg-4.my-3
        img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/temas/img9.png', alt='')
      .col-lg-12.my-3
        TabsC.color-acento-contenido.tamano-tabs
