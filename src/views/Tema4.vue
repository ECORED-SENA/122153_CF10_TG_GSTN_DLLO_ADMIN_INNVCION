...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p(data-aos="fade-down").mb-4 Para establecer un esquema de clasificación de los datos se debe iniciar por analizar la naturaleza organizacional y el enfoque de información que se requiere administrar y seguido de ello se debe generar esquemas integrales que se adapten a las necesidades. Por consiguiente, a continuación se exponen algunas de las generalidades a tener en cuenta:

    .row
      .col-12
        .titulo-sexto.color-acento-contenido
          p.mb-0 #[b Figura 2.] Esquema de clasificación de los datos
        img.img-a.img-t.mb-5(data-aos="zoom-in")(src='@/assets/curso/temas/img15.svg', alt='Esquema de clasificación de los datos. La imagen muestra el esquema de la clasificación de los datos, iniciando por: Clasificación (cualitativo, cuantitativo, cronológicos, geográfico). Abiertos. Cerrados. Confidenciales. Secretos. Ultra secretos.')
    ...
    p(data-aos="fade-down").mb-4 Lo invitamos a ver el siguiente video que presenta el esquema de clasificación de los datos.
